...
function getDAQ()
{
	...
	if (NUT == null || NOW > NUT)
	{
		$.ajax(
		{
			url: "http://www-bd.fnal.gov/getdaq/job/G:SYBS.STATUS[0].ON@U;F:MT6SC1.READING[0].RAW@E,36;S:MTNRG.READING[0].PRIMARY@U;F:MCENRG.READING[0].PRIMARY@U;F:MT6AB1.STATUS[0].ON@U;F:MTPCDC.STATUS[0].ON@U;S:G2SEM.READING[0].COMMON@E,36;F:NEUCDC.STATUS[0].ON@U;F:MC7SC1.READING[0].RAW@E,36;F:MCCDC.STATUS[0].ON@U;G:SCTIME.READING[0].COMMON@U;G:SCTIME.SETTING[0].COMMON@U;G:E36SCT.READING[0].COMMON@U?iso-time=true&type=xml",
			datatype: "xml",
